# ⚠️ CHOPS LINUX PORT (UNOFFICIAL FORK) ⚠️

> **NOTE:** This is a fork of the original [Chops](https://github.com/Shpigford/chops) macOS application.
> This repository has been completely refactored from native macOS SwiftUI into a **Cross-Platform Tauri App (Svelte + Rust)** to support **Linux** (and eventually Windows).
>
> 🐧 **Status:** [![Build Status](https://img.shields.io/badge/build-passing-brightgreen)](#) Linux MVP is working! 
> 🛠️ **Build:** `bun tauri dev` or `bun tauri build`
